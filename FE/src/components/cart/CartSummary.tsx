...
export function CartSummary({ subtotal, itemCount, onCheckout }: CartSummaryProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-xl p-6">
          ...
          <div className="relative">
            ...
            <AnimatePresence>
              {showPromoSuggestions && !appliedPromo && (
                ...
                >
                  <div className="p-3">
                    <p className="text-xs text-slate-400 mb-2">Available Codes:</p>
        ...
        <div className="space-y-3 py-4 border-t border-white/10">
          ...
          {appliedPromo && discount > 0 && (
            ...
            >
              <span className="text-green-400">Discount ({appliedPromo.code})</span>
      ...
      {/* Payment Methods */}
      <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-xl p-6">
        <h4 className="text-sm font-medium mb-4">Accepted Payment Methods</h4>
