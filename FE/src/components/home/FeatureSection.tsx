...
const featureKeys = [
  { icon: Store, titleKey: 'home.features.digitalStore', descKey: 'home.features.digitalStoreDesc' },
  { icon: BookOpen, titleKey: 'home.features.gameLibraryManagement', descKey: 'home.features.gameLibraryManagementDesc' },
  { icon: Users, titleKey: 'home.features.friendsCommunity', descKey: 'home.features.friendsCommunityDesc' },
  { icon: Trophy, titleKey: 'home.features.achievements', descKey: 'home.features.achievementsDesc' },
  { icon: Wallet, titleKey: 'home.features.walletPayment', descKey: 'home.features.walletPaymentDesc' },
  { icon: Smartphone, titleKey: 'home.features.crossDeviceSync', descKey: 'home.features.crossDeviceSyncDesc' },
];
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4">
            {t('home.features.title')} <span className="bg-linear-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">{t('home.features.titleHighlight')}</span>
          </h2>
