...
export function FlappyBirdGame({ libraryGameId }: FlappyBirdGameProps) {
  ...
  const userHighestScoreQuery = useGetUserHighestScore();

  useEffect(() => {
    if (userHighestScoreQuery.data && leaderboardQuery.data) {
      setBestScore(userHighestScoreQuery.data.highest_score);
    }
  }, [userHighestScoreQuery.data, leaderboardQuery.data]);
      ...
      <div className="flappy-shell">
          ...
          {phase === "gameover" && (
            <div className="flappy-overlay">
              <div className="flappy-panel">
                ...
                <p>
                  Your bird hit an obstacle. Try again and beat your best score.
                </p>
        ...
        <div className="flappy-footer">
          <div className="flappy-instructions">
            ...
            <p>
              Avoid pipes, stay above the ground, and score by passing each
              pipe.
            </p>
          </div>
          ...
          <div className="flappy-leaderboard">
            ...
            {leaderboardQuery.data &&
              ...
              !leaderboardQuery.isError && (
                <p>
                  No leaderboard data yet. Be the first to set a high score!
                </p>
              )}
          </div>
        </div>
